...
<ul>
	...
	<li class="dropdown">
		<a href="PEL2.php" class="dropbtn">PEL</a>
		<div class="dropdown-content">
			<a href="javascript:void(0)">Prime Entertainment League. Battle monthly for shiny prices and Prime Points.</a>
		</div>
	</li>
	<li class="dropdown">
		<a href="Battle-Area.html" class="dropbtn">Gym Battles</a>
		<div class="dropdown-content">
			<a href="Battle-Area.html">Here you can Battle Gym Leaders and Elite Four Members<br>
										(inspired by the real game data).<br>Earn badges and qualify for the Prime League.</a>
		</div>
	</li>
	<li class="dropdown">
		<a href="league-off.html" class="dropbtn">Prime League</a>
		<div class="dropdown-content">
			<a href="league-off.html">Those who own all eight Stage 2 Badges<br>are able to participate in the Prime League <br>
						to become the Prime League Champion.</a>
		</div>
	</li>
	<li class="dropdown">
		<a href="database.html" class="dropbtn">Trainer Database</a>
		<div class="dropdown-content">
			<a href="database.html">Here you can find all Trainers<br>who are registered in the Prime League<br>and everything we've seen from them so far.</a>
		</div>
	</li>
	<li class="dropdown" style="padding-left:50px;">
		<a href="registrieren.php" class="signupbtn">Sign Up</a>
	</li>
	<li class="dropdown">
	...
	<div id="mobile-nav">
		<a href="index.html" class="topbar" style="padding: 2px 4px; background: rgba(220,160,140,0.0);">
		...
		<a href="registrieren.php" style="float:right" class="signupbtn">Sign Up</a>
		<a href="login.php" style="float:right" class="signinbtn">Login</a>
		<div id="Links">
			<a href="index.html" class="dropbtn">Home</a>
			<a href="PEL2.php" class="dropbtn">PEL</a>
			<a href="Battle-Area.html" class="dropbtn">Gym Battles</a>
...
<div>
	...
	<div id="pelgeneral" style="display:;">
		...
		<a href="registrieren.php"><input type="submit" value="Register now!"></a>
		<p style="font-size:30px;text-align:center;">to participate in the PEL!</p>
		...
		<h3>What is the PEL?</h3>
			The PEL is a format where you can battle monthly against other trainers to earn prices. You can also get <a id="link" href="content2.html">Prime Points</a> 
		...
		<h3>What prices can you win?</h3>
			...
			<a id="link" href="content3.html">Here you can find a table.</a><br><br>
	...
	<div class="top-banner">
		<img onClick="showmonth(event)" class="August" src="images/top-banner-august.png" width="100%"></img>
		</div>	
	...
	<div class="top-banner">
		<img onClick="showmonth(event)" class="June" src="images/top-banner-june.png" width="100%"></img>
		</div>	
		...
		<div class="back-current-PEL">
				 ...
				 <div class="matches-top-info">
					...
					<a class="top-black-link" href="database.html#LovelyTheFirst">LovelyTheFirst</a><br>
					0 v 3 <br>
					<a class="top-black-link" href="database.html#eviLDiabolus">eviLDiabolus</a>
					</div>
					<div class="top-block">
					28 June 2019 - 22:30<br>
					<a class="top-black-link" href="database.html#Killerdogge">Killerdogge</a><br>
					0 v 4 <br>
					<a class="top-black-link" href="database.html#LovelyTheFirst">LovelyTheFirst</a>
					</div>
					<div class="top-block">
					28 June 2019 - 23:00<br>
					<a class="top-black-link" href="database.html#eviLDiabolus">eviLDiabolus</a><br>
					2 v 0 <br>
					<a class="top-black-link" href="database.html#Killerdogge">Killerdogge</a>
					</div>
				</div> 
	...
	<div class="top-banner">
		<img onClick="showmonth(event)" class="May" src="images/top-banner-may.png" width="100%"></img>
		</div>	
		...
		<div class="back-current-PEL">
				 ...
				 <div class="matches-top-info">
					...
					<a class="top-black-link" href="database.html#LovelyTheFirst">LovelyTheFirst</a><br>
					6 v 0 <br>
					<a class="top-black-link" href="database.html#Killerdogge">Killlerdogge</a>
					</div>
				</div> 
	...
	<div class="top-banner">
		<img onClick="showmonth(event)" class="April" src="images/top-banner-apr.png" width="100%"></img>
		</div>	
		...
		<div class="back-current-PEL">
				 ...
				 <div class="matches-top-info">
					...
					<a class="top-black-link" href="database.html#LovelyTheFirst">eviLDiabolus</a><br>
					1 v 0 <br>
					<a class="top-black-link" href="database.html#eviLDiabolus">LovelyTheFirst</a>
					</div>
				</div> 
	...
	<div class="top-banner">
		<img onClick="showmonth(event)" class="March" src="images/top-banner-mar.png" width="100%"></img>
		</div>	
		...
		<div class="top-banner">
		<img onClick="showmonth(event)" class="February" src="images/top-banner-feb.png" width="100%"></img>
		</div>	
		...
		<div class="back-current-PEL">
				<div class="matches-top-info">
					...
					<a class="top-black-link" href="database.html#Ounaghi">Ounaghi</a><br>
					0 v 3 (ff)<br>
					<a class="top-black-link" href="database.html#Kerberos">Kerberos</a>
					</div>
					<div class="top-block">
					01 March 2019 - 20:30<br>
					<a class="top-black-link" href="database.html#Lovely">LovelyTheFirst</a><br>
					3 v 0 (ff)<br>
					<a class="top-black-link" href="database.html#Ounaghi">Ounaghi</a>
					</div>
					<div class="top-block">
					01 March 2019 - 21:00<br>
					<a class="top-black-link" href="database.html#Kerberos">Kerberos</a><br>
					0 v 5<br>
					<a class="top-black-link" href="database.html#Lovely">LovelyTheFirst</a>					
					</div>
				</div>
